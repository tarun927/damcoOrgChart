...
const EmployeeCard = React.memo(({ employee, toggleSubordinates }) => {
    const isVacant = !employee.name || employee.name === "Vacant Position";
    return (React.createElement("div", { className: `employee-card ${isVacant ? "vacant" : ""}`, onClick: toggleSubordinates }, !isVacant ? (React.createElement("div", { className: "card-content" },
        React.createElement("img", { className: "employee-photo", src: employee.imageBase64 }),
        React.createElement("div", { className: "employee-name-label" }, "\u0627\u0644\u0627\u0633\u0645:"),
        React.createElement("div", { className: "employee-name" }, employee.name),
        React.createElement("div", { className: "employee-designation" }, employee.designation || "No Designation"))) : (React.createElement("div", { className: "vacant-card" },
        React.createElement("div", { className: "vacant-text" }, "\u0645\u0646\u0635\u0628 \u0634\u0627\u063A\u0631"),
        React.createElement("div", { className: "vacant-designation" }, employee.designation || "No Designation")))));
});
...
class ErrorBoundary extends React.Component {
    ...
    render() {
        if (this.state.hasError) {
            return React.createElement("div", { className: "error-message" }, "Something went wrong");
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const React = __importStar(__webpack_require__(294));
const EmployeeCard_1 = __importDefault(__webpack_require__(154)); // Importing EmployeeCard component
...
const OrgChart = ({ data }) => {
    ...
    const [visibleSubordinates, setVisibleSubordinates] = React.useState({});
    ...
    const toggleSubordinates = React.useCallback((employeeIndex) => {
        setVisibleSubordinates(prevState => {
            const currentValue = prevState[employeeIndex] !== undefined ? prevState[employeeIndex] : true;
            const newValue = !currentValue;
            const newState = Object.assign(Object.assign({}, prevState), { [employeeIndex]: newValue });
            console.log("Updated visibleSubordinates:", newState);
            return newState;
        });
    }, []);
    // Render the employee tree
    const renderEmployeeNode = React.useCallback((employee) => {
        const hasSubordinates = employee.subordinates && employee.subordinates.length > 0;
        const isVisible = visibleSubordinates[employee.index] !== false; // Default to true to show subordinates initially
        return (React.createElement("div", { className: "employee-cell", key: employee.index },
            React.createElement(EmployeeCard_1.default, { employee: employee, toggleSubordinates: () => toggleSubordinates(employee.index) }),
            hasSubordinates && (React.createElement("div", { className: "subordinates", style: { display: isVisible ? "flex" : "none" } }, employee.subordinates.map(subordinate => renderEmployeeNode(subordinate))))));
    }, [visibleSubordinates, toggleSubordinates]);
    return (React.createElement("div", { style: { position: "relative" } },
        React.createElement("div", { className: "orgChart", ref: orgChartRef, style: {
                transform: `translate(${translateX}px, ${translateY}px) scale(${zoomLevel})`,
                transformOrigin: "0 0",
                cursor: isDragging ? "grabbing" : "grab",
            } },
            React.createElement("div", { className: "org-chart-container" }, employeeTree.map(employee => renderEmployeeNode(employee)))),
        React.createElement("div", { className: "zoom-control-container" },
            React.createElement("button", { className: "zoom-control-btn", onClick: () => setZoomLevel(prevZoom => Math.min(prevZoom + 0.1, 2)) }, "+"),
            React.createElement("button", { className: "zoom-control-btn", onClick: () => setZoomLevel(prevZoom => Math.max(prevZoom - 0.1, 0.5)) }, "-"))));
};
...
function buildEmployeeTree(employees) {
    ...
    employees.forEach(emp => {
        employeesMap.set(emp.index, Object.assign(Object.assign({}, emp), { subordinates: [] }));
    });
    const rootEmployees = [];
    employees.forEach(emp => {
...
__webpack_require__(71);
const React = __importStar(__webpack_require__(294));
const client_1 = __webpack_require__(745); // Updated import
const OrgChart_1 = __importDefault(__webpack_require__(637));
const ErrorBoundary_1 = __importDefault(__webpack_require__(114));
class Visual {
    constructor(options) {
        console.log("Visual constructor", options);
        this.target = options.element;
        // Create a root.
        this.root = (0, client_1.createRoot)(this.target);
    }
    update(options) {
        ...
        this.root.render(React.createElement(ErrorBoundary_1.default, null, React.createElement(OrgChart_1.default, { data: data })));
    }
    destroy() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const visual_1 = __webpack_require__(832);
...
exports["default"] = damcoOrgChartBC9AA1AC56E8468AA3D896339DF88E60_DEBUG;
